...
export const templates: Template[] = [
  {
    ...
    description:
      "A simple dashboard with basic stock cards and a table for trending stocks.",
    widgetExamples: [
      "Apple & Tesla Stock Cards",
      "Top 5 Trending Stocks Table",
    ...
    widgets: [
      ...
      },
      {
        ...
        config: { apiProvider: "alpha-vantage", keywords: "AAPL" },
  ...
  },
  {
    ...
    description:
      "For active traders needing real-time candlestick charts, watchlists, and news.",
    widgetExamples: [
      "Real-time Candlestick Chart (TSLA)",
      "Watchlist Table",
      "News Ticker",
      "RSI + MA Indicators",
    ],
    widgets: [
      ...
      },
      {
        componentName: "DataTableWidget",
        title: "Watchlist",
        config: { apiProvider: "alpha-vantage", keywords: "TSLA" },
  ...
  },
  {
    ...
    description:
      "Focus on portfolio overviews, historical performance, and dividend tracking.",
    widgetExamples: [
      "Portfolio Sector Split",
      "10-Year Historical Chart (MSFT)",
      "Dividend Tracker",
      "S&P 500 Index Card",
    ],
    widgets: [
  ...
  },
  {
    ...
    description:
      "Track crypto prices, view real-time charts, and gauge market sentiment.",
    widgetExamples: [
      "Crypto Price Cards (BTC, ETH)",
      "Real-time Candlestick (BTC/USDT)",
      "Fear & Greed Index",
      "Top Gainers/Losers",
    ],
    widgets: [
  ...
  },
  {
    ...
    description:
      "Monitor currency exchange rates, commodities, and global indices.",
    widgetExamples: [
    ...
    widgets: [
      ...
      },
      {
        ...
        config: { apiProvider: "alpha-vantage", keywords: "index" },
        layout: { lg: { i: "", x: 6, y: 0, w: 6, h: 5 } },
      },
    ],
  },
